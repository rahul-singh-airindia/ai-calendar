...
@Component({
  selector: 'bidding-calendar',
  templateUrl: './bidding-calendar.component.html',
  styleUrls: ['./bidding-calendar.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class BiddingCalendarComponent implements OnInit {
  @Input('font-family')
  ...
  @Input('biddingCalendar')
  biddingCalendar: BiddingCalendarData[] = [];

  biddingCalendarData: BiddingCalendarData[] = [];
  ...
  ngOnInit(): void {
    this.biddingCalendarData = this.biddingCalendar;
  ...
  getStartedEvents(date: Date) {
    return this.biddingCalendarData.filter((course) => {
